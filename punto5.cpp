...
int main() {
    ...
    cout << "Multiplicacion (int): " << calc.multiplicar(10, 5) << endl;
    cout << "Multiplicacion (float): " << calc.multiplicar(10.5f, 5.2f) << endl;
    cout << "Division (int): " << calc.dividir(10, 5) << endl;
    cout << "Division (float): " << calc.dividir(10.5f, 5.2f) << endl;
    return 0;
}
